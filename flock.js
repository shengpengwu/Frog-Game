...
(function () {
	...
	if (stop) {
		...
		context.fillText ('Click to Start', CANVAS_PADDING + 5, $('canvas').height () - CANVAS_PADDING - 5);
	    }
	    if (lost) {
		context.font = 'bold 30px sans-serif';
		context.fillText ('Oops! You became the dinner of a snake.', CANVAS_PADDING + 5, $('canvas').height () - CANVAS_PADDING - 5 - 36);
		context.fillText ('Perhaps your friend Rango will mourn for you. Rest in peace!', CANVAS_PADDING + 5, $('canvas').height () - CANVAS_PADDING - 5);
	    }
	    else if (won) {
		context.font = 'bold 30px sans-serif';
		context.fillText ('Congrats! You spent ' + Math.round (time)  + ' seconds to get your food.', CANVAS_PADDING + 5, $('canvas').height () - CANVAS_PADDING - 5 - 36);
		context.fillText ('You\'re definitely the Lightning McQueen of the pond!', CANVAS_PADDING + 5, $('canvas').height () - CANVAS_PADDING - 5);
	    }
	}
    };
